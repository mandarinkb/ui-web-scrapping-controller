...
export class FolderService {
  ...
  // update อัพเดต folder และใช้ id ของ user ไปค้นหาชื่อคนที่อัพเดตโฟเดอร์ (แก้แล้ว)
  ...
  // update อัพเดต subfolder และใช้ id ของ user ไปค้นหาชื่อคนที่อัพเดตโฟเดอร์ (แก้แล้ว)
  updateSubFolder(formSubFolder: Subfolder , id: number) {
    return this.http.put(this.rootURL + '/folder/' + id + '?token=' + this.authen.getAuthenticated(), formSubFolder);
  }
  /*
  // delete
