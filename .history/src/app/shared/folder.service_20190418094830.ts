...
export class FolderService {
  ...
  // create สร้าง main folder (แก้แล้ว)
  createSubFolder(formSubFolder: Subfolder) {  // แก้แล้ว
    return this.http.post(this.rootURL + '/sub-folder', formSubFolder, this.httpOptions);
  }
  // update
  updateSubFolder(formSubFolder: Subfolder , id: number) {  // แก้แล้ว
